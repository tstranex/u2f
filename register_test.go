...
func TestRegistrationExample(t *testing.T) {
	...
	regResp, _ := hex.DecodeString("")

	r, err := parseRegistration(regResp)
	if err != nil {
	...
	actualSig := hex.EncodeToString(r.signature)
	...
	err = verifyRegistrationSignature(*r, appID, []byte(clientData))
	if err != nil {
